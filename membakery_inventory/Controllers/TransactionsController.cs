...
namespace membakery_inventory.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        {
            var transactions = db.Transactions.Include(t => t.Employee).Include(t => t.Stock);
        ...
        public ActionResult Create([Bind(Include = "TransactionNo,Emp_ID,Stock_ID,TQuantity,TotalPrice,Date")] Transaction transaction)
        {
